    ...
    <q-form @submit="guardar" ref="myForm">
          ...
          <div class="row">
            ...
            >
              <template v-slot:hint>
                ...
                >
                  <q-icon size="1.2em" color="light-blue" name="info" /> Serán
                  asignadas a este año
                </q-item-label>
              </template>
            </q-select>
          </div>
                          ...
                          <q-icon
                            ...
                            :name="
                              files[i].correcto
                                ...
                                : 'mdi-alpha-x-circle'
                            "
                            :color="files[i].correcto ? 'green-6' : 'negative'"
                          />
                        </q-avatar>
                        <q-avatar>
      ...
      <q-card-actions v-else-if="!envioAGuardar" align="center">
        <q-item class="q-pr-sm">
          <q-btn
            style="min-width: 220px"
            :color="files.length > 0 ? 'primary' : 'grey-6'"
            type="submit"
