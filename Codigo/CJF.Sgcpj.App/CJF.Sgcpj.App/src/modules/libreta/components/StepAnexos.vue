<template>
      ...
      <template v-for="(anexo, i) in value.anexos" v-bind:key="anexo.id">
        <q-card class="col-3 q-ml-xl q-mb-sm">
          ...
          <q-card-section>
            ...
            <q-item-label class="q-pb-xs"
              ><span class="mdi mdi-circle-medium"></span
              >{{ anexo.descripcion?.descripcion }}</q-item-label
            >
            <q-item-label class="q-pb-xs"
              ><span class="mdi mdi-circle-medium"></span
              >{{ anexo.caracter?.descripcion }}</q-item-label
            >
          </q-card-section>
  ...
  <!-- <div class="col-4">
        <info-promocion :detallePromocion="value" step="3"></info-promocion>
      </div> -->
</template>
