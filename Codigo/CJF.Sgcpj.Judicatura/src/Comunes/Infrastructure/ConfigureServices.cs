...
namespace CJF.Sgcpj.Judicatura.Common.Infrastructure;
...
public static class ConfigureServices
{
    public static IServiceCollection AddInfrastructureServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IRutasChunkRepository, RutasChunkRepository>();
        ...
        services.AddTransient<IWordsUtil, WordUtilsForAspose>();
        ...
        services.AddTransient<AsposeLicense>();
