...
public class PromocionDetalleTablero
{
    ...
    public long? ParteAsociadaId { get; set; } //Validar
    ...
    public short? BanderaNoCapturada { get; set; } // Bandera para saber si esta o no capturada la demanda electronica
}
