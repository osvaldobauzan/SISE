...
public class SubirAnexoComandoValidator : AbstractValidator<SubirAnexosComando>
{
    private readonly IConfiguration _configuration;
    private readonly IWordValidator _wordValidator;

    public SubirAnexoComandoValidator(IConfiguration configuration, IWordValidator wordValidator)
    {
