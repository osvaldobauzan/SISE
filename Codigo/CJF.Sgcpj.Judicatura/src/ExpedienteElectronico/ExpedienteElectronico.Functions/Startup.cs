...
using CJF.Sgcpj.Judicatura.ExpedienteElectronico.Infrastructure;
    ...
    public override void Configure(IFunctionsHostBuilder builder)
    {
        ...
        builder.Services.AddSingleton<IOpenApiConfigurationOptions>(_ =>
        {
            var options = new OpenApiConfigurationOptions()
            {
                ...
                {
                    Version = "v1",
                    Title = $"API para Expediente Electrónico",
                    Description = "Esta API proporciona endpoints para gestionar los procesos del Expediente Electrónico",
