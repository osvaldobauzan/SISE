namespace CJF.Sgcpj.Judicatura.Promovente.Application.Utils;
...
public class Functions
{
    ...
    public static Stream ImageFromRawBgraArray(byte[] arr)
    {
        ...
        using (var fs = new FileStream(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, $"{Functions.GenerateStringRandom(15)}.jpeg"), FileMode.Create, FileAccess.Write))
        {
