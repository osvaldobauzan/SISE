...
using CJF.Sgcpj.Judicatura.Promovente.Infrastructure;
...
using CJF.Sgcpj.Judicatura.Promovente.Application;
    ...
    public override void Configure(IFunctionsHostBuilder builder)
    {
        ...
        builder.Services.AddSingleton<IOpenApiConfigurationOptions>(_ =>
        {
            var options = new OpenApiConfigurationOptions()
            {
                ...
                {
                    Version = "v1",
                    Title = $"API de Promovente",
                    Description = "Esta API proporciona endpoints para gestionar los promoventes",
        ...
        builder.Services.AddPromoventeInfrastructureServices(configuration);
        builder.Services.AddApplicationPromoventeServices();
