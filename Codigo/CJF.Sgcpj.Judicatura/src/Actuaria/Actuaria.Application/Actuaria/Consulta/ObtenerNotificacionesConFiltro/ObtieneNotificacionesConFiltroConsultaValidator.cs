...
public class ObtieneNotificacionesConFiltroConsultaValidator : AbstractValidator<ObtieneNotificacionesConFiltroConsulta>
{
    public ObtieneNotificacionesConFiltroConsultaValidator()
    {
