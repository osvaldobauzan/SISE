...
public class ActualizarParteTests : IClassFixture<TestStartup>, IAsyncLifetime
{
    private readonly TestsInitializer _testsInitializer;
    private readonly ActualizarParteFunction? _sut;
    private readonly ILogger<ActualizarParteTests> _logger;

    public ActualizarParteTests(TestsInitializer testsInitializer)
    {
        _testsInitializer = testsInitializer;
        _sut = _testsInitializer.ServiceProvider.GetService<ActualizarParteFunction>();
        _logger = _testsInitializer.ServiceProvider.GetService<ILogger<ActualizarParteTests>>();
    }
    ...
    {
        // Arrange
        var req = TestCommon.CreatePostMockRequest(new PersonaAsuntoUpdate()
        {
            AsuntoNeunId = 1,
            UsuarioCaptura = 1,
            PersonaId = 1,
