...
namespace CJF.Sgcpj.Judicatura.Application.UnitTests.Common.Mappings
{
    public class MappingTests
    {
        ...
        [Test]
        [TestCase(typeof(CatalogoAsunto), typeof(CatalogoAsuntoDto))]
        [TestCase(typeof(ObtienePromocionesConFiltroConsulta), typeof(ConsultaPaginada))]
        [TestCase(typeof(AgregarPromocion), typeof(AgregarPromocionDto))]
