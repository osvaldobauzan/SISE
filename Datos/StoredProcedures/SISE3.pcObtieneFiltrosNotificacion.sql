...
-- =============================================
CREATE OR ALTER PROCEDURE [SISE3].[pcObtieneFiltrosNotificacion] 
(
...
select 
    a.EmpleadoId, CONCAT(ce.Nombre, ' ', ce.ApellidoPaterno, ' ', ce.ApellidoMaterno) as NombreActuario 
from dbo.Areas a 
...
Select a.EmpleadoId,  CONCAT(ce.Nombre, ' ', ce.ApellidoPaterno, ' ', ce.ApellidoMaterno) as NombreActuario
from dbo.Areas a
    inner join dbo.CatEmpleados ce on ce.EmpleadoId = a.EmpleadoId
