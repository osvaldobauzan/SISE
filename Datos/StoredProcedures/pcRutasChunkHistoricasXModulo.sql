...
/****** Object:  StoredProcedure [SISE3].[pcRutasChunkHistoricasXModulo]    Script Date: 12/1/2023 6:22:33 PM ******/
SET ANSI_NULLS ON
GO
...
@Grupo        INT=NULL
            ...
            BEGIN TRY 
					IF @pi_Modulo = 'Oficialia'
					BEGIN
						select KId,iGrupo,sDescripcion,iTipoArchivo,sTipoArchivoDesc,sRuta,iEscritura from CAT_RutasChunk rc with(nolock) where rc.iGrupo = 2 and rc.iEscritura = 0  order by fFechaAlta desc
					End
