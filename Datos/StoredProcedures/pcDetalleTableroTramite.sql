...
/****** Object:  StoredProcedure [SISE3].[pcDetalleTableroTramite]    Script Date: 12/1/2023 6:15:10 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT a.CatOrganismoId, a.AsuntoId, a.AsuntoNeunId, sa.SintesisOrden, sa.FechaAlta as FechaCaptura, ad.AsuntoDocumentoId, ad.CatAutorizacionDocumentosId, ad.FechaAlta, ad.NombreArchivo, ad.NombreDocumento, ad.CatContenidoId
	FROM Asuntos a INNER JOIN SintesisAcuerdoAsunto sa ON a.CatOrganismoId = sa.CatOrganismoId AND a.AsuntoNeunId = sa.AsuntoNeunId
