...
/****** Object:  StoredProcedure [SISE3].[piInsertaExpedientePromocionyArchivo]    Script Date: 12/1/2023 6:26:35 PM ******/
SET ANSI_NULLS ON
GO
...
-- ============================================= 
CREATE PROCEDURE [SISE3].[piInsertaExpedientePromocionyArchivo]
	(
...
BEGIN
	...
	--END
		...
		BEGIN TRY
				...
				THROW 51000,'Ya existe el Numero de expediente para este organismo, Materia y Tipo de Asunto',1;
